...
<?php  $Introduction = M("Introduction"); $data = $Introduction->select(); $calendar = $data[0]["calendar"]; ?>
<div class = "container" style="padding-top:80px; padding-left:200px; padding-right:200px;">
	<?php echo $calendar;?>
</div>